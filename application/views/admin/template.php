...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= base_url('assets/images/favicon/short-logo.png') ?>">
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
      ...
      <div class="bg-primary brand-link">
        <a href="">
          <img src="<?= base_url('assets/images/logo/logomini.png') ?>" alt="Einpi." class="brand-image img-circle elevation-3 bg-white" style="opacity: .8">
    ...
    <footer class="main-footer">
      <strong>&copy; <?= date('Y') ?> <a href="#" target="_BLANK">Einpi.</a></strong>
